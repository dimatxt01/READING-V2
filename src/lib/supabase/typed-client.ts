...
export type FeatureFlagsRow = Tables['feature_flags']['Row']
...
export type FeatureFlagsInsert = Tables['feature_flags']['Insert']
...
export type FeatureFlagsUpdate = Tables['feature_flags']['Update']
